...
$(function () {
    var url = location.href.indexOf("localhost") !== -1 ? 'http://followyourheart.sinaapp.com/Demos/musicPlayer/resource/play_list.json' : 'http://followyourheart.sinaapp.com/Demos/musicPlayer/playlist.php?id=5175955';
    $.ajax({
        url: url,
        type: 'GET',
        dataType: 'json',
